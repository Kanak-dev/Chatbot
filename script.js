...
const API_KEY = "AIzaSyDqbJ1KZH_lyazXzQ06OmKW9ezDZR8iu_o";
let UserText = null;
...
const loadDataFromLocalStorage = () => {
  ...
  const defaultText = `<div class="default-text">
                            <h1>Medbot</h1>
                            <h3>Explore the power of medbot<br>Your chat will be displayed here.</h3>
                        </div>`;
...
const showTypingAnimation = () => {
  const html = `<div class="chat-content">
                    <div class="chat-details">
                        <img src="./assets/bot.png" alt="chatbot-img" style="width: 80px;
                        height: 70px;">
...
loadDataFromLocalStorage();
sendButton.addEventListener("click", handleOutgoingChat);const chatInput = document.querySelector(".chat-input");
const sendButton = document.querySelector(".send-btn");
const chatContainer = document.querySelector(".chat-container");
const deleteButton = document.querySelector(".delete-btn");
const themeButton = document.querySelector(".theme-btn");
